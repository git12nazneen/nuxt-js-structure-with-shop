<template>
    <div>
        <header class=" flex items-center justify-between h-16 px-4 mx-auto rounded bg-slate-100 dark:bg-gray-50">
            <NuxtLink to="/" rel="noopener noreferrer" aria-label="Homepage">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32"
                    class="w-6 h-6 dark:text-violet-600">
                    <path
            ...
            <div class="items-center hidden space-x-8 lg:flex">
                ...
                <button class="px-4 py-2 rounded-md dark:bg-violet-600 dark:text-gray-50">Sign up</button>
            </div>
